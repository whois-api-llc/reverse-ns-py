...
class ReverseNsApiError(Exception):
...
class ParameterError(ReverseNsApiError):
    pass


class EmptyApiKeyError(ReverseNsApiError):
    pass


class ResponseError(ReverseNsApiError):
    def __init__(self, message):
        self.message = message
...
class UnparsableApiResponseError(ReverseNsApiError):
...
class HttpApiError(ReverseNsApiError):
    pass
